...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/admin/assistance-categories',
    },
];
...
export default function AssistanceCategories() {
    ...
    const handleCreate = () => {
        router.post('/admin/assistance-categories', formData, {
    ...
    const handleUpdate = () => {
        ...
        router.put(`/admin/assistance-categories/${selectedCategory.id}`, formData, {
            preserveScroll: false,
            onSuccess: () => {
    ...
    const handleDelete = () => {
        ...
        router.delete(`/admin/assistance-categories/${selectedCategory.id}`, {
            preserveScroll: false,
            onSuccess: () => {
