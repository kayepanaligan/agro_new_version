...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/admin/monitoring-categories',
    },
];
...
export default function MonitoringCategories({ categories }: Props) {
    ...
    const handleCreate = () => {
        createForm.post(route('admin.monitoring-categories.store'), {
            onSuccess: () => {
                createForm.reset();
    ...
    const handleUpdate = () => {
        ...
        editForm.put(route('admin.monitoring-categories.update', selectedCategory.crop_monitoring_category_id), {
            onSuccess: () => {
                editForm.reset();
                setIsEditOpen(false);
    ...
    const handleDelete = (id: number) => {
        if (confirm('Are you sure you want to delete this category?')) {
            router.delete(route('admin.monitoring-categories.destroy', id));
        }
    };
