...
export default function FundingSources() {
    ...
    const handleCreate = () => {
        router.post('/admin/funding-sources', formData, {
    ...
    const handleUpdate = () => {
        ...
        router.put(`/admin/funding-sources/${selectedFundingSource.id}`, formData, {
            preserveScroll: false,
            onSuccess: () => {
    ...
    const handleDelete = () => {
        ...
        router.delete(`/admin/funding-sources/${selectedFundingSource.id}`, {
            preserveScroll: false,
            onSuccess: () => {
